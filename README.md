...
*- :x: 不可复现
*- 渴望大家一起把 [MMec]https://github.com/enoche/MMRec) 这个领域做扎实！
...
- [Learning Hybrid Behavior Patterns for Multimedia Recommendation](https://dl.acm.org/doi/abs/10.1145/3503161.3548119) - Zongshen Mu, Yueting Zhuang, Jie Tan, Jun Xiao, Siliang Tang. **MM, Oct 2022** :interrobang: 
- [Multi-modal Graph Contrastive Learning for Micro-video Recommendation](https://dl.acm.org/doi/abs/10.1145/3477495.3532027) -  Zixuan Yi, Xi Wang, Iadh Ounis, Craig Macdonald. **SIGIR, Jul 2022** :interrobang: 
