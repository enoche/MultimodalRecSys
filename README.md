...
- [Bootstrap Latent Representations for Multi-modal Recommendation](https://arxiv.org/abs/2207.05969) - Xin Zhou, Hongyu Zhou, Yong Liu, Zhiwei Zeng, Chunyan Miao, Pengwei Wang, Yuan You, Feijun Jiang. **arxiv, Jul 2022** | [`[code]`](https://github.com/enoche/BM3)
...
- [DualGNN: Dual Graph Neural Network for Multimedia Recommendation](https://ieeexplore.ieee.org/abstract/document/9662655)  - Qifan Wang, Yinwei Wei, Jianhua Yin, Jianlong Wu, Xuemeng Song, Liqiang Nie.  **TMM, Dec 2021**  | [`[code]`](https://github.com/wqf321/dualgnn)
...
- [Pre-training Graph Transformer with Multimodal Side Information for Recommendation](https://dl.acm.org/doi/abs/10.1145/3474085.3475709) - Yong Liu, Susen Yang, Chenyi Lei, Guoxin Wang, Haihong Tang, Juyong Zhang, Aixin Sun and Chunyan Miao. **MM, Oct 2021** | [`[code]`](https://github.com/uoo723/PMGT)
