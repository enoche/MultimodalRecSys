...
A curated list of awesome multimodal recommendation resources (***code first***: messy code is better than no code.). Please contact us if your work is not in the list.  
